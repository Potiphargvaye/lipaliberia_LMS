<!-- Sidenav -->
<div class="fixed left-0 top-0 w-64 h-screen z-50 sidebar-menu transition-transform bg-sky-700 flex flex-col">

    <!-- Logo (UNCHANGED) -->
    <a href="#"
        class="flex font-semibold items-center py-2 px-4 text-white hover:bg-[#002966] hover:text-white rounded-md">
        <h2 class="font-bold text-2xl">
            LIPA <span class="bg-[#f84525] text-white px-2 rounded-md">Liberia</span>
        </h2>
    </a>
    ...
    <div class="flex-1 overflow-y-auto px-4 mt-4">
        ...
        <ul>
          ...
          {{ request()->is('admin/announcements*') ? 'bg-[#002966]' : '' }}">
            ...
            <span class="text-orange-500 hover:text-orange-700 font-bold">Access Control</span>
        ...
        group-[.active]:bg-[#002966] group-[.active]:text-white sidebar-dropdown-toggle">
                    ...
                    <i class="ri-shield-keyhole-line mr-3 text-lg"></i>
